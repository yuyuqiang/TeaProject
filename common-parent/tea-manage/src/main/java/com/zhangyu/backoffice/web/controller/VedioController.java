...
//        return null;
    ...
    public String downloadVedio(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        System.out.println("hhhhhhhh"+vedio.getVedioAttachment());
        //获取到项目下upload目录的绝对路径
//        String realPath = request.getServletContext().getRealPath("/WEB-INF/Modules/upload/");
...
//                    String realPath="E:\\TeachingWebsite\\TeaProject\\common-parent\\tea-manage\\src\\main\\webapp\\WEB-INF\\Modules\\upload\\";
        ...
        map.put("vedioAttachment", attr1[1]);
        map.put("imageAttachment", attr1[0]);


        map.put("attachmentOldName", attr[1]);
        map.put("image",attr[0]);


        //vedio.setImage(attr[0]);
        //将MAP中的数据封装在Vedio对象上
