...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/chat/static/plugins/amaze/css/amazeui.min.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/chat/static/plugins/amaze/css/admin.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/chat/static/plugins/contextjs/css/context.standalone.css">
    <script src="${pageContext.request.contextPath}/static/chat/static/plugins/jquery/jquery-2.1.4.min.js"></script>
    <script src="${pageContext.request.contextPath}/static/chat/static/plugins/amaze/js/amazeui.min.js"></script>
    <script src="${pageContext.request.contextPath}/static/chat/static/plugins/amaze/js/app.js"></script>
    <script src="${pageContext.request.contextPath}/static/chat/static/plugins/layer/layer.js"></script>
    <script src="${pageContext.request.contextPath}/static/chat/static/plugins/laypage/laypage.js"></script>
    <script src="${pageContext.request.contextPath}/static/chat/static/plugins/contextjs/js/context.js"></script>
...
<script>
    ...
    function showChat(message){
        ...
        var html = "<li class=\"am-comment "+isSef+" am-comment-primary\"><a href=\"#link-to-user-home\"><img width=\"48\" height=\"48\" class=\"am-comment-avatar\" alt=\"\" src=${pageContext.request.contextPath}/assets1/Images/touxiang.jpg></a><div class=\"am-comment-main\">\n" +
    ...
    function tuling(message){
        ...
        $.getJSON("http://www.tuling123.com/openapi/api?key=6ad8b4d96861f17d68270216c880d5e3&info=" + message,function(data){
            if(data.code == 100000){
                html = "<li class=\"am-comment am-comment-primary\"><a href=\"#link-to-user-home\"><img width=\"48\" height=\"48\" class=\"am-comment-avatar\" alt=\"\" src=\"${ctx}/static/chat/static/source/img/robot.jpg\"></a><div class=\"am-comment-main\">\n" +
            ...
            if(data.code == 200000){
                html = "<li class=\"am-comment am-comment-primary\"><a href=\"#link-to-user-home\"><img width=\"48\" height=\"48\" class=\"am-comment-avatar\" alt=\"\" src=\"${ctx}/static/chat/static/source/img/robot.jpg\"></a><div class=\"am-comment-main\">\n" +
                        "<header class=\"am-comment-hd\"><div class=\"am-comment-meta\">   <a class=\"am-comment-author\" href=\"#link-to-user\">Robot</a> 发表于<time> "+getDateFull()+"</time> 发送给: ${username}</div></header><div class=\"am-comment-bd\"> <p>"+data.text+"</p><a href=\""+data.url+"\" target=\"_blank\">"+data.url+"</a></div></div></li>";
            }
            $("#chat").append(html);
            var chat = $("#chat-view");
