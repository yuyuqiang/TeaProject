...
<head>
  ...
  <meta name="format-detection" content="telephone=no"> 
	...
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/manager01/common/global.css">
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/manager01/css/main.css" media="all">
</head>
<body>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/manager01/jsplug/echarts.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/manager01/js/main.js"></script>
</body>
</html>