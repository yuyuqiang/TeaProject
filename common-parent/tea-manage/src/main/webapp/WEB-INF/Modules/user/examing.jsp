...
<head>
    ...
    <title>${title }</title>
    <link href="${pageContext.request.contextPath}/static/home/exam/css/main.css" rel="stylesheet" type="text/css" />
    <link href="${pageContext.request.contextPath}/static/home/exam/css/iconfont.css" rel="stylesheet" type="text/css" />
    <link href="${pageContext.request.contextPath}/static/home/exam/css/test.css" rel="stylesheet" type="text/css" />
    <style>
        .hasBeenAnswer {
            background: #5d9cec;
            color:#fff;
            ...
            <div class="test">
                <form action="" method="post">
                    <div class="test_title">
                        <p class="test_time">
                            <img style="float:left;margin-top:15px;margin-left:10px;" src="${pageContext.request.contextPath}/static/home/exam/images/time.png" width="16px"><b class="alt-1">${hour }:${minitute }:${second }</b>
                        </p>
...
<script src="${pageContext.request.contextPath}/static/home/exam/js/jquery-1.11.3.min.js"></script>
<script src="${pageContext.request.contextPath}/static/home/exam/js/jquery.easy-pie-chart.js"></script>
<!--时间js-->
<script src="${pageContext.request.contextPath}/static/home/exam/js/jquery.countdown.js"></script>
<script>
        ...
        $.ajax({
            ...
            success: function(data){
                if(data.type == 'success'){
                    ...
                    window.location="${pageContext.request.contextPath}/user/index.do";
                }else{
                    alert(data.msg);
                    //$(".tm_btn_primary").text('提交');
                    //return;
