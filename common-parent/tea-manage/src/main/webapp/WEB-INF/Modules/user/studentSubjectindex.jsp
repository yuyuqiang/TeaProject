         ...
         <div class="ui container">
             <div class="ui large secondary network menu inverted">
                 ...
                 <div class="right item">
                     ...
                     <img class="ui avatar image" src="${pageContext.request.contextPath}/assets1/Images/touxiang.jpg">
                     <span>${username}</span>
                     <div class="menu">
                         <a href="${pageContext.request.contextPath}/user/login_index.do" class="item">注销</a>
                     </div>
                 </div>
             </div>
         </div>
...
<%--                      <img  src="${pageContext.request.contextPath}/assets1/Images/logoko11.png">--%>
                      ...
                      <div class="extra content">
                          ...
                          <c:if test="${subject.id == subjectId}">
                             <button href="#" onclick="start_study()" class="ui inverted primary button" style="margin-left: 70px">开始学习</button>
                          </c:if>
                      </div>
                      </div>
                  </br>
