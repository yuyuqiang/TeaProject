...
<div class="wrap">
    <table>
        <tr>
            <td rowspan="5" style=""><img src="${pageContext.request.contextPath}/static/home/exam/images/error.jpg" alt="错误页面"></td>
            <td class="header">很抱歉！当前操作出现错误</td>
        </tr>
        <tr><td>原因：${msg }</td></tr>
        <tr><td class="check-info">点击前往首页<a href="${pageContext.request.contextPath}/user/welcomeExam.do">考生首页</a></td></tr>
    </table>
</div>
</body>
</html>
