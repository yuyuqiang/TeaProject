...
<body>
    ...
    <div class="main">
                    ...
                    <ul id="show_iframe" class="switch_nav">
						<li class="nav_current">
							<a href="#" class="subNavigation" id="A001010"
							   ...
							   data-url="${pageContext.request.contextPath}/teacher/comments.do">班级交流</a>
						</li>
						<li class="nav_current">
							<a href="#" class="subNavigation" id="A001011"
							   data-name="common_iframe" onclick="Common.switchNavigation(this);"
							   data-url="${pageContext.request.contextPath}/vedio/vedioPrev.do">私信</a>
						</li>
		...
		<div id="common_iframe" class="maincontent">
			<iframe class="common_iframe" id="A001010_iframe" frameborder="0" border="0" src="${pageContext.request.contextPath}/teacher/comments.do"></iframe>
		</div>
    </div>
    </form>
</body>
